...
public class LiquidFiller extends Module {
    ...
    private boolean isOutOfRange(BlockPos blockPos) {
        ...
        ClipContext raycastContext = new ClipContext(mc.player.getEyePosition(), blockPos.getCenter(), net.minecraft.world.level.ClipContext.Block.COLLIDER, net.minecraft.world.level.ClipContext.Fluid.NONE, mc.player);
