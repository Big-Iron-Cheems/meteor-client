...
public class HighwayBuilder extends Module {
    ...
    private enum State {
        ...
        Forward {
            ...
            private boolean isCrystalTrap(HighwayBuilder b) {
                for (Entity entity : b.mc.level.entitiesForRendering()) {
                    ...
                    return b.mc.level.clip(new ClipContext(vec1, vec2, net.minecraft.world.level.ClipContext.Block.COLLIDER, ClipContext.Fluid.NONE, b.mc.player)).getType() == HitResult.Type.MISS;
                }
        ...
        DefuseCrystalTraps {
             ...
             * bow. The {@link Minecraft#handleKeybinds} method is only called when you are not in a screen,
             ...
             *
             * @see meteordevelopment.meteorclient.mixin.MinecraftMixin#wrapStopUsing(MultiPlayerGameMode, Player)
             */
            @Override
            protected void tick(HighwayBuilder b) {
                if (cooldown > 0) {
