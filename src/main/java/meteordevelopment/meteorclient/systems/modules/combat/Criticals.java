...
public class Criticals extends Module {
                    ...
                    case Jump, MiniJump -> {
                        if (!sendPackets) {
                            ...
                            if (mode.get() == Mode.Jump) {
                                ...
                                ((IVec3d) mc.player.getDeltaMovement()).meteor$setY(0.25);
                                sendTimer = 4;
                            }
                            event.cancel();
                        }
    ...
    private void sendPacket(double height) {
        ...
        ServerboundMovePlayerPacket packet = new ServerboundMovePlayerPacket.Pos(x, y + height, z, false, mc.player.horizontalCollision);
