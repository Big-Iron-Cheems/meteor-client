    ...
    private void onTick(TickEvent.Pre event) {
        ...
        if (mode.get() == Mode.AirPlace) {
            ...
            Rotations.rotate(mc.player.getYRot(), 90, Integer.MAX_VALUE, () -> {
                ...
                ((IVec3d) mc.player.getDeltaMovement()).meteor$setY(preY);
            });
        }
        ...
        // Bucket mode
            ...
            if (mc.player.fallDistance > 3 && !EntityUtils.isAboveWater(mc.player)) {
                ...
                BlockHitResult result = mc.level.clip(new ClipContext(mc.player.position(), mc.player.position().subtract(0, 5, 0), net.minecraft.world.level.ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, mc.player));
